                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://jchsportal.com/assets/images/main_logo.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:28px;font-weight:bold;line-height:1;text-align:center;color:#555;">
                                                <u>Jay College of Health Sciences</u>
                                                <br>
                                                <br>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                              This email is to confirm your payment on {{ \Carbon\Carbon::now()->format('m/d/Y h:m') }}.
                                              <br>
                                              Transaction ID: {{ $details['trxID'] }}
                                              <br>
                                              Payment Type: {{ $details['paymentType'] }}
                                              <br>
                                              Paid Amount: {{ $details['amount'] }}
                                              <br>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Best regards,<br><br> Jay College of Health Sciences INC
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                5275 Babcock Street, Suite #3, Palm Bay, FL 32905
                                                            </div>
