                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @permission('edit-student-profile')
                          ...
                          <a href="{{ route('studentinfo.delete', $student->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to remove this student?')"><i class="fa fa-trash"></i></a>
                        @endpermission
