          ...
          <div class="login-box bg-white box-shadow border-radius-10">
            ...
            <form action="{{ route('student.login') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="input-group custom">
                ...
                <input type="text" class="form-control form-control-lg" placeholder="AA1111" name="student_id" />
              ...
              <div class="input-group custom mt-3">
                ...
                <input type="password" class="form-control form-control-lg" placeholder="**********" name="password" data-toggle="tooltip" data-placement="top"
                       title="Default Password: student#, change this password after you login.">
              </div>
              <div class="input-group custom">
          ...
          <form action="{{ route('send.otp') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="email" name="email" class="form-control" placeholder="student@student.com" aria-describedby="helpId">
