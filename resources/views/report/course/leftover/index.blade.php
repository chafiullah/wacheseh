...
@section('title', 'Student Leftover courses')
    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_content">
              <form action="{{ route('report.course.leftover.list') }}" method="post">
                @csrf
                <div class="form-row">
                ...
                <tbody>
                  @foreach ($student_list as $item)
                    <tr>
                      ...
                      <td>
                        <ul>
                          @foreach ($item->program_outline as $outline)
                            <li> {{ $outline->course->course_code . ' - ' . $outline->course->course_name }}</li>
                          @endforeach
                        </ul>
                      </td>
                    </tr>
