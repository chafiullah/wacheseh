      ...
      <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            ...
            <div class="x_title">
              <h2>Send<small> Custom Notifications.</small></h2>
              <div class="clearfix"></div>
            </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                    ...
                    <select class="form-control" id="studentType" name="studentType" required>
                      ...
                      <option value="specific">select specific {{ config('constant.active') }} students</option>
                      <option value="{{ config('constant.active') }}">select all {{ config('constant.active') }} students</option>
                  ...
                  <div class="form-group col-md-12" id="specificStudents" style="display:none;">
                    ...
                    <select name="studentIDs[]" class="form-control select2" multiple>
                      ...
                      @foreach ($students as $item)
                        <option value="{{ $item->id }}">Class - {{ $item->class . ' - ' . $item->first_name . '  ' . $item->last_name }}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    <button type="submit" class="btn btn-success pull-right"><i class="fas fa-paper-plane    "></i> send</button>
                  </div>
                </div>
              </form>
            </div>
